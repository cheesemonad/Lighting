...
obj scene(float x, float y) {
  obj c1 = { circleSDF(x, y, 0.3f, 0.25f, 0.14f), 3.0f };
  obj c2 = { circleSDF(x, y, 0.35f, 0.7f, 0.09f), 2.0f };
  obj c3 = { circleSDF(x, y, 0.73f, 0.43f, 0.06f), 0.0f };
  obj c4 = { circleSDF(x, y, 0.32f, 0.25f, 0.04f), 0.0f };
  return csg_union(c1, csg_union(c2, c3));
}
...
int main() {
  ...
  svpng(fopen("circles.png", "wb"), W, H, img, 0);
  return 0;
}
